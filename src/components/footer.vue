<template>
    <section id='foot_guide'>
        ...
        <!--gotoAddress({path: '/investment', query: {geohash}})-->
        <section @click = "gotoAddress('/investment')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('investment') !== -1? '#msiteActive' : '#msite'"></use>
            </svg>
            <span>人品投资</span>
        </section>
        
        <section @click = "gotoAddress('/Cardindex')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('Cardindex') !== -1? '#orderActive' : '#order'"></use>
            </svg>
            <span>人品卡</span>
        </section>
